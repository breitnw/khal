# FIXME remove after khal is updated in nixpkgs-unstable

{ lib, stdenv, fetchFromGitHub, glibcLocales, installShellFiles, python3Packages
, }:
...
python3Packages.buildPythonApplication rec {
  ...
  postInstall = ''
    ...
    PATH="${
      ...
      (ps: with ps; [ sphinx sphinxcontrib-newsfeed ])
    }/bin:$PATH" \
      make -C doc man
